    ...
    def forward(
        ...
        with torch.set_grad_enabled(
            ...
            if (
                ...
                elif self.guidance_hooks is not None:
                    # Exit inference_mode so the diffusion-conditioning tensors
                    # can be used in autograd-tracked computations downstream.
